  	...
  	<form>
	    <div className="form-group">
	      ...
	      <input
	        ...
	        className="form-control" id="nickname" placeholder="Enter nickname"
	        defaultValue={obj.user.nickname} onChange={obj.handleChangeFormUser} />
	    </div>
        <div className="form-group">
          ...
          <input
            ...
            defaultValue={obj.user.password} onChange={obj.handleChangeFormUser} />
        </div>
